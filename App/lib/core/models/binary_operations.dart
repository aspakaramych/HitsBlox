...
class BinaryOperations implements Expression{
  ...
  dynamic evaluate(VariableRegistry registry) {
    ...
    switch (operator){
      case "+": return (l is num && r is num) ? l + r : throw "Invalid types";
      case "-": return (l is num && r is num) ? l - r : throw "Invalid types";
      case "*": return (l is num && r is num) ? l * r : throw "Invalid types";
      case "/": return (l is num && r is num) ? ((r != 0) ? (l ~/ r) : throw "Divide zero") : throw "Invalid types";
      case "==": return l == r;
      case "!=": return l != r;
      case ">": return (l is Comparable && r is Comparable) ? l.compareTo(r) > 0 : false;
      case "<": return (l is Comparable && r is Comparable) ? l.compareTo(r) < 0 : false;
