...
class SwapBlockWidget extends StatefulWidget {
  final SwapBlock block;
  ...
  @override
  _SwapBlockWidgetState createState() => _SwapBlockWidgetState();
}

class _SwapBlockWidgetState extends State<SwapBlockWidget> {
                        ...
                        children: [
                          Padding(
                            ...
                            child: Wrap(
                              ...
                              runSpacing: 2,
                              children: [
                                if (widget.block.node.rawExpressionFirst != '')
                                  Center(
                                    child: SizedBox(
                                      width: 100,
                                      child: Container(
                                ...
                                Center(
                                  child: Padding(
                                    ...
                                    child: Wrap(
                                      ...
                                      runSpacing: 2,
                                      children: [
                                        if (widget.block.node.rawExpressionSecond != '')
                                          SizedBox(
                                            width: 100,
                                            child: Container(
                                              decoration: BoxDecoration(
