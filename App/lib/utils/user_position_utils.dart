...
class UserPositionUtils {
  static void centerInitialPosition(BuildContext context, TransformationController transformationController) {
    ...
    transformationController.value = Matrix4.identity()..translate(-centerX, -centerY);
  }

  static Rect getVisibleContentRect(TransformationController transformationController) {
